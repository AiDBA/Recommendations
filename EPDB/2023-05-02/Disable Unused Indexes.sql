...
BEGIN TRY
	...
	ON [ReportServerTempDB].[dbo].[ChunkData] DISABLE;
	PRINT 'INDEX [PK_ChunkData] ON [ReportServerTempDB].[dbo].[ChunkData] IS DISABLED.';
	END
END TRY
BEGIN CATCH
	PRINT 'INDEX [PK_ChunkData] ON [ReportServerTempDB].[dbo].[ChunkData] CANNOT BE DISABLED.';
END CATCH;
