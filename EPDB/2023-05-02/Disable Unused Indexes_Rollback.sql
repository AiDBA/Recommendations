...
BEGIN TRY
	...
	ON [ReportServerTempDB].[dbo].[ChunkData] REBUILD WITH (SORT_IN_TEMPDB = ON);
	PRINT 'INDEX [PK_ChunkData] ON [ReportServerTempDB].[dbo].[ChunkData] IS ENABLED.';
END TRY
BEGIN CATCH
	PRINT 'INDEX [PK_ChunkData] ON [ReportServerTempDB].[dbo].[ChunkData] CANNOT BE ENABLED.';
END CATCH;
