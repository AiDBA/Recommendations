...
Date: 8/30/2023 12:56:21 PM UTC
*/
BEGIN TRY     CREATE NONCLUSTERED INDEX AIDBA_NCIX_230830125623 ON [OCS].[DBO].[A_COMMON_AUTOSUGGEST] ([MODULENAME],[FIELDNAME],[FIELDVALUE]) INCLUDE ([CREATEDBY],[CREATEDDATE],[UPDATEDBY],[UPDATEDDATE],[FIELDVALUE2]) ;
