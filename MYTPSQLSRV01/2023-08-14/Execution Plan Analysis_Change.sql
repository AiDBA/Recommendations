...
Date: 8/14/2023 8:27:26 AM UTC
*/
BEGIN TRY     CREATE NONCLUSTERED INDEX AIDBA_NCIX_230814082728 ON [COLOS].[DBO].[SSSCC] ([ID],[PREFIX]) ;
...
BEGIN TRY     CREATE UNIQUE INDEX [IX_AIDBA_IX_SLIST_UNIQUE] ON [COLOS].[DBO].[SLIST] ([INTVALUE],[STRLISTNAME]) INCLUDE ([STRDESCRIPTION]) WITH (DROP_EXISTING=OFF );
 END TRY BEGIN CATCH END CATCH;
BEGIN TRY     CREATE NONCLUSTERED INDEX AIDBA_NCIX_230814082734 ON [OCS].[DBO].[MSTDEPARTMENT] ([ROWID],[ACTIVEIND]) INCLUDE ([NAME]) ;
 END TRY BEGIN CATCH END CATCH;
