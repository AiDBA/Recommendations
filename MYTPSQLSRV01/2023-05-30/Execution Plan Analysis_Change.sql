...
Date: 5/30/2023 12:15:12 AM UTC
*/
BEGIN TRY     CREATE NONCLUSTERED INDEX AIDBA_NCIX_230530001515 ON [COLOS].[DBO].[SPALLETLINE_SDEVICE] ([ID],[SPALLETLINEID]) INCLUDE ([SDEVICEID]) ;
...
BEGIN TRY     CREATE  INDEX [IX_AIDBA_IX_SESSIONLOG] ON [VEEAMONE].[REPORTER].[SESSIONLOG] ([SESSIONID]) INCLUDE ([DETAILS],[LOGDATETIME]) WITH (DROP_EXISTING=OFF );
 END TRY BEGIN CATCH END CATCH;
BEGIN TRY     CREATE NONCLUSTERED INDEX AIDBA_NCIX_230530001543 ON [VEEAMONE].[MONITOR].[BPJOBSESSION] ([UID],[BP_SERVER_ID],[AGG_DURATION],[DELETE_TIME]) ;
 END TRY BEGIN CATCH END CATCH;
