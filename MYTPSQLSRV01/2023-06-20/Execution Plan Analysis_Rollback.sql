...
BEGIN TRY 
    DROP INDEX AIDBA_NCIX_230620022956 ON [OCS].[DBO].[CCZA_LOADINGAPPOINTMENTTIME_LINKAGE_AGT]; 
END TRY 
BEGIN CATCH 
END CATCH;
...
BEGIN TRY 
    DROP INDEX AIDBA_NCIX_230620023001 ON [VEEAMONE].[MONITOR].[BPEXTERNALPLATFORM]; 
END TRY 
BEGIN CATCH 
END CATCH;
