...
BEGIN TRY 
    DROP INDEX AIDBA_NCIX_230519003126 ON [OCS].[DBO].[CCZA_LOADINGAPPOINTMENTTIME_LINKAGE_AGT]; 
END TRY 
BEGIN CATCH 
END CATCH;
...
BEGIN TRY 
    DROP INDEX AIDBA_NCIX_230519003129 ON [VEEAMONE].[MONITOR].[BPEXTERNALPLATFORM]; 
END TRY 
BEGIN CATCH 
END CATCH;
