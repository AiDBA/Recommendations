...
BEGIN TRAN
	...
	BEGIN
		...
		WHERE i.name <> N'IX_AIDBA_1_20230502' AND i.object_id = OBJECT_ID('[SPRITZERTAIPINGDB].[dbo].[LOCATION]') 
		AND EXISTS
		(SELECT *
		FROM sys.indexes i2
		INNER JOIN sys.index_columns ic2
		ON i2.index_id = ic2.index_id AND i2.object_id = ic2.object_id 
		WHERE i2.name = N'IX_AIDBA_1_20230502' AND i2.object_id = OBJECT_ID('[SPRITZERTAIPINGDB].[dbo].[LOCATION]')
		...
		BEGIN
			DROP INDEX IX_AIDBA_1_20230502 ON [SPRITZERTAIPINGDB].[dbo].[LOCATION];
			IF @pre_is_disable = 1
			BEGIN
			...
			ELSE
			BEGIN
				PRINT N'INDEX IX_AIDBA_1_20230502 ON [SPRITZERTAIPINGDB].[dbo].[LOCATION] WILL NOT BE CREATED.';
			END
		END
		ELSE
		BEGIN
			PRINT N'INDEX IX_AIDBA_1_20230502 ON [SPRITZERTAIPINGDB].[dbo].[LOCATION] WILL BE CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_1_20230502 ON [SPRITZERTAIPINGDB].[dbo].[LOCATION] CANNOT BE CREATED DUE TO RUNTIME ERROR.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		INNER JOIN sys.index_columns ic
		ON i.index_id = ic.index_id AND i.object_id = ic.object_id
		WHERE i.name <> N'IX_AIDBA_2_20230502' AND i.object_id = OBJECT_ID('[SPRITZERTAIPINGDB].[dbo].[AUDIT_TRAIL_PARAM_PROP]') 
		AND EXISTS
		(SELECT *
		FROM sys.indexes i2
		INNER JOIN sys.index_columns ic2
		ON i2.index_id = ic2.index_id AND i2.object_id = ic2.object_id 
		WHERE i2.name = N'IX_AIDBA_2_20230502' AND i2.object_id = OBJECT_ID('[SPRITZERTAIPINGDB].[dbo].[AUDIT_TRAIL_PARAM_PROP]')
		AND i.object_id = i2.object_id
		AND i.type = i2.type
		AND ic.index_column_id = ic2.index_column_id 
		AND ic.column_id = ic2.column_id
		...
		IF @pre_iid IS NOT NULL
		BEGIN
			DROP INDEX IX_AIDBA_2_20230502 ON [SPRITZERTAIPINGDB].[dbo].[AUDIT_TRAIL_PARAM_PROP];
			IF @pre_is_disable = 1
			BEGIN
			...
			ELSE
			BEGIN
				PRINT N'INDEX IX_AIDBA_2_20230502 ON [SPRITZERTAIPINGDB].[dbo].[AUDIT_TRAIL_PARAM_PROP] WILL NOT BE CREATED.';
			END
		END
		ELSE
		BEGIN
			PRINT N'INDEX IX_AIDBA_2_20230502 ON [SPRITZERTAIPINGDB].[dbo].[AUDIT_TRAIL_PARAM_PROP] WILL BE CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_2_20230502 ON [SPRITZERTAIPINGDB].[dbo].[AUDIT_TRAIL_PARAM_PROP] CANNOT BE CREATED DUE TO RUNTIME ERROR.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		INNER JOIN sys.index_columns ic
		ON i.index_id = ic.index_id AND i.object_id = ic.object_id
		WHERE i.name <> N'IX_AIDBA_3_20230502' AND i.object_id = OBJECT_ID('[SPRITZERTAIPINGDB].[dbo].[TRANSPORT_LOG]') 
		AND EXISTS
		(SELECT *
		FROM sys.indexes i2
		INNER JOIN sys.index_columns ic2
		ON i2.index_id = ic2.index_id AND i2.object_id = ic2.object_id 
		WHERE i2.name = N'IX_AIDBA_3_20230502' AND i2.object_id = OBJECT_ID('[SPRITZERTAIPINGDB].[dbo].[TRANSPORT_LOG]')
		AND i.object_id = i2.object_id
		AND i.type = i2.type
		AND ic.index_column_id = ic2.index_column_id 
		AND ic.column_id = ic2.column_id
		...
		IF @pre_iid IS NOT NULL
		BEGIN
			DROP INDEX IX_AIDBA_3_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANSPORT_LOG];
			IF @pre_is_disable = 1
			BEGIN
			...
			ELSE
			BEGIN
				PRINT N'INDEX IX_AIDBA_3_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANSPORT_LOG] WILL NOT BE CREATED.';
			END
		END
		ELSE
		BEGIN
			PRINT N'INDEX IX_AIDBA_3_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANSPORT_LOG] WILL BE CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_3_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANSPORT_LOG] CANNOT BE CREATED DUE TO RUNTIME ERROR.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		INNER JOIN sys.index_columns ic
		ON i.index_id = ic.index_id AND i.object_id = ic.object_id
		WHERE i.name <> N'IX_AIDBA_4_20230502' AND i.object_id = OBJECT_ID('[SPRITZERTAIPINGDB].[dbo].[TRANS]') 
		AND EXISTS
		(SELECT *
		FROM sys.indexes i2
		INNER JOIN sys.index_columns ic2
		ON i2.index_id = ic2.index_id AND i2.object_id = ic2.object_id 
		WHERE i2.name = N'IX_AIDBA_4_20230502' AND i2.object_id = OBJECT_ID('[SPRITZERTAIPINGDB].[dbo].[TRANS]')
		AND i.object_id = i2.object_id
		AND i.type = i2.type
		AND ic.index_column_id = ic2.index_column_id 
		AND ic.column_id = ic2.column_id
		...
		IF @pre_iid IS NOT NULL
		BEGIN
			DROP INDEX IX_AIDBA_4_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANS];
			IF @pre_is_disable = 1
			BEGIN
			...
			ELSE
			BEGIN
				PRINT N'INDEX IX_AIDBA_4_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANS] WILL NOT BE CREATED.';
			END
		END
		ELSE
		BEGIN
			PRINT N'INDEX IX_AIDBA_4_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANS] WILL BE CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_4_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANS] CANNOT BE CREATED DUE TO RUNTIME ERROR.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		INNER JOIN sys.index_columns ic
		ON i.index_id = ic.index_id AND i.object_id = ic.object_id
		WHERE i.name <> N'IX_AIDBA_5_20230502' AND i.object_id = OBJECT_ID('[SPRITZERTAIPINGDB].[dbo].[HOST_MESSAGE]') 
		AND EXISTS
		(SELECT *
		FROM sys.indexes i2
		INNER JOIN sys.index_columns ic2
		ON i2.index_id = ic2.index_id AND i2.object_id = ic2.object_id 
		WHERE i2.name = N'IX_AIDBA_5_20230502' AND i2.object_id = OBJECT_ID('[SPRITZERTAIPINGDB].[dbo].[HOST_MESSAGE]')
		AND i.object_id = i2.object_id
		AND i.type = i2.type
		AND ic.index_column_id = ic2.index_column_id 
		AND ic.column_id = ic2.column_id
		...
		IF @pre_iid IS NOT NULL
		BEGIN
			DROP INDEX IX_AIDBA_5_20230502 ON [SPRITZERTAIPINGDB].[dbo].[HOST_MESSAGE];
			IF @pre_is_disable = 1
			BEGIN
			...
			ELSE
			BEGIN
				PRINT N'INDEX IX_AIDBA_5_20230502 ON [SPRITZERTAIPINGDB].[dbo].[HOST_MESSAGE] WILL NOT BE CREATED.';
			END
		END
		ELSE
		BEGIN
			PRINT N'INDEX IX_AIDBA_5_20230502 ON [SPRITZERTAIPINGDB].[dbo].[HOST_MESSAGE] WILL BE CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_5_20230502 ON [SPRITZERTAIPINGDB].[dbo].[HOST_MESSAGE] CANNOT BE CREATED DUE TO RUNTIME ERROR.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		BEGIN
			DROP INDEX IX_AIDBA_1_20230502 ON [SPRITZERTAIPINGDB].[dbo].[LOCATION];
			PRINT N'HYPOTHETICAL INDEX IX_AIDBA_1_20230502 ON [SPRITZERTAIPINGDB].[dbo].[LOCATION] IS DROPPED DUE TO DUPLICATION.';
			IF @is_disable = 1
			BEGIN
		...
		BEGIN
			...
			PRINT N'INDEX IX_AIDBA_1_20230502 ON [SPRITZERTAIPINGDB].[dbo].[LOCATION] IS CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_1_20230502 ON [SPRITZERTAIPINGDB].[dbo].[LOCATION] CANNOT BE CREATED.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		BEGIN
			DROP INDEX IX_AIDBA_2_20230502 ON [SPRITZERTAIPINGDB].[dbo].[AUDIT_TRAIL_PARAM_PROP];
			PRINT N'HYPOTHETICAL INDEX IX_AIDBA_2_20230502 ON [SPRITZERTAIPINGDB].[dbo].[AUDIT_TRAIL_PARAM_PROP] IS DROPPED DUE TO DUPLICATION.';
			IF @is_disable = 1
			BEGIN
		...
		BEGIN
			...
			PRINT N'INDEX IX_AIDBA_2_20230502 ON [SPRITZERTAIPINGDB].[dbo].[AUDIT_TRAIL_PARAM_PROP] IS CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_2_20230502 ON [SPRITZERTAIPINGDB].[dbo].[AUDIT_TRAIL_PARAM_PROP] CANNOT BE CREATED.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		BEGIN
			DROP INDEX IX_AIDBA_3_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANSPORT_LOG];
			PRINT N'HYPOTHETICAL INDEX IX_AIDBA_3_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANSPORT_LOG] IS DROPPED DUE TO DUPLICATION.';
			IF @is_disable = 1
			BEGIN
		...
		BEGIN
			...
			PRINT N'INDEX IX_AIDBA_3_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANSPORT_LOG] IS CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_3_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANSPORT_LOG] CANNOT BE CREATED.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		BEGIN
			DROP INDEX IX_AIDBA_4_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANS];
			PRINT N'HYPOTHETICAL INDEX IX_AIDBA_4_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANS] IS DROPPED DUE TO DUPLICATION.';
			IF @is_disable = 1
			BEGIN
		...
		BEGIN
			...
			PRINT N'INDEX IX_AIDBA_4_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANS] IS CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_4_20230502 ON [SPRITZERTAIPINGDB].[dbo].[TRANS] CANNOT BE CREATED.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		BEGIN
			DROP INDEX IX_AIDBA_5_20230502 ON [SPRITZERTAIPINGDB].[dbo].[HOST_MESSAGE];
			PRINT N'HYPOTHETICAL INDEX IX_AIDBA_5_20230502 ON [SPRITZERTAIPINGDB].[dbo].[HOST_MESSAGE] IS DROPPED DUE TO DUPLICATION.';
			IF @is_disable = 1
			BEGIN
		...
		BEGIN
			...
			PRINT N'INDEX IX_AIDBA_5_20230502 ON [SPRITZERTAIPINGDB].[dbo].[HOST_MESSAGE] IS CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_5_20230502 ON [SPRITZERTAIPINGDB].[dbo].[HOST_MESSAGE] CANNOT BE CREATED.';
END CATCH;
