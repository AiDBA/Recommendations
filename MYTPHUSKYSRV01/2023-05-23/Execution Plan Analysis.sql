...
Date: 5/23/2023 1:12:37 AM UTC
*/
BEGIN TRY     CREATE NONCLUSTERED INDEX AIDBA_NCIX_230523011240 ON [FUSIONOPERATIONAL].[DBO].[MESSAGINGSCHEDULEDREPORT] ([RULEID]) INCLUDE ([RULESCHEDULEDREPORTID],[SCHEDULEPARAMETER],[REPORTPARAMETER]) WITH (ONLINE=ON,DATA_COMPRESSION=PAGE,ALLOW_PAGE_LOCKS=OFF);
