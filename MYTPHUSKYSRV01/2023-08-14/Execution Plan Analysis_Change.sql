...
Date: 8/14/2023 8:22:40 AM UTC
*/
BEGIN TRY     CREATE NONCLUSTERED INDEX AIDBA_NCIX_230814082243 ON [FUSIONOPERATIONAL].[DBO].[RUNACTIVITY] ([STARTTIME],[ENDTIME]) INCLUDE ([RUNID]) WITH (ONLINE=ON,DATA_COMPRESSION=PAGE,ALLOW_PAGE_LOCKS=OFF);
