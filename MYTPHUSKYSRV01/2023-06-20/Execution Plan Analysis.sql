...
Date: 6/20/2023 2:25:02 AM UTC
*/
BEGIN TRY     CREATE NONCLUSTERED INDEX AIDBA_NCIX_230620022504 ON [FUSIONOPERATIONAL].[DBO].[MESSAGINGRULERECIPIENT] ([RULEID]) INCLUDE ([RECIPIENTID]) WITH (ONLINE=ON,DATA_COMPRESSION=PAGE,ALLOW_PAGE_LOCKS=OFF);
