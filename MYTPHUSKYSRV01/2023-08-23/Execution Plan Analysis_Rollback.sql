...
BEGIN TRY 
    DROP INDEX AIDBA_NCIX_230823111156 ON [FUSIONOPERATIONAL].[DBO].[BOMPARTITEM]; 
END TRY 
BEGIN CATCH 
END CATCH;
...
BEGIN TRY 
    CREATE UNIQUE INDEX [PK_SQCVALUE] ON [FUSIONOPERATIONAL].[DBO].[SQCVALUE] ([VALUEID]) WITH (DROP_EXISTING=ON , ONLINE=ON, DATA_COMPRESSION=PAGE,ALLOW_PAGE_LOCKS=OFF); 
END TRY 
BEGIN CATCH 
END CATCH;
