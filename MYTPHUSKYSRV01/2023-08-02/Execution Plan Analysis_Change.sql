...
Date: 8/2/2023 11:38:33 AM UTC
*/
BEGIN TRY     CREATE NONCLUSTERED INDEX AIDBA_NCIX_230802113835 ON [FUSIONOPERATIONAL].[DBO].[RUNACTIVITY] ([ENDTIME],[STARTTIME]) INCLUDE ([RUNID]) WITH (ONLINE=ON,DATA_COMPRESSION=PAGE,ALLOW_PAGE_LOCKS=OFF);
