...
Date: 8/21/2023 10:15:28 AM UTC
*/
BEGIN TRY     CREATE NONCLUSTERED INDEX AIDBA_NCIX_230821101531 ON [FUSIONOPERATIONAL].[DBO].[SEQUENCE] ([DATETM]) INCLUDE ([ONEHOURLATER]) WITH (ONLINE=ON,DATA_COMPRESSION=PAGE,ALLOW_PAGE_LOCKS=OFF);
