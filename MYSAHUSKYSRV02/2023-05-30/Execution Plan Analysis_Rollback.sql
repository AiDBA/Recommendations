...
BEGIN TRY 
    DROP INDEX AIDBA_NCIX_230530000716 ON [REPORTSERVER].[DBO].[KEYS]; 
END TRY 
BEGIN CATCH 
END CATCH;
...
BEGIN TRY 
    CREATE UNIQUE INDEX [IX_ENERGYSENSORDATA_TIMESTAMP_ENERGYSENSORID] ON [FUSIONOPERATIONAL].[DBO].[ENERGYSENSORDATA] ([ENERGYSENSORID],[TIMESTAMP]) WITH (DROP_EXISTING=ON ); 
END TRY 
BEGIN CATCH 
END CATCH;
