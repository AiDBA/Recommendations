...
BEGIN TRAN
	...
	BEGIN
		...
		INNER JOIN sys.index_columns ic
		ON i.index_id = ic.index_id AND i.object_id = ic.object_id
		WHERE i.name <> N'IX_AIDBA_2_20230506' AND i.object_id = OBJECT_ID('[FusionOperational].[dbo].[Downtime]') 
		AND EXISTS
		(SELECT *
		FROM sys.indexes i2
		INNER JOIN sys.index_columns ic2
		ON i2.index_id = ic2.index_id AND i2.object_id = ic2.object_id 
		WHERE i2.name = N'IX_AIDBA_2_20230506' AND i2.object_id = OBJECT_ID('[FusionOperational].[dbo].[Downtime]')
		AND i.object_id = i2.object_id
		AND i.type = i2.type
		AND ic.index_column_id = ic2.index_column_id 
		AND ic.column_id = ic2.column_id
		...
		IF @pre_iid IS NOT NULL
		BEGIN
			DROP INDEX IX_AIDBA_2_20230506 ON [FusionOperational].[dbo].[Downtime];
			IF @pre_is_disable = 1
			BEGIN
			...
			ELSE
			BEGIN
				PRINT N'INDEX IX_AIDBA_2_20230506 ON [FusionOperational].[dbo].[Downtime] WILL NOT BE CREATED.';
			END
		END
		ELSE
		BEGIN
			PRINT N'INDEX IX_AIDBA_2_20230506 ON [FusionOperational].[dbo].[Downtime] WILL BE CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_2_20230506 ON [FusionOperational].[dbo].[Downtime] CANNOT BE CREATED DUE TO RUNTIME ERROR.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		INNER JOIN sys.index_columns ic
		ON i.index_id = ic.index_id AND i.object_id = ic.object_id
		WHERE i.name <> N'IX_AIDBA_3_20230506' AND i.object_id = OBJECT_ID('[FusionDW].[dbo].[ETLWatermark]') 
		AND EXISTS
		(SELECT *
		FROM sys.indexes i2
		INNER JOIN sys.index_columns ic2
		ON i2.index_id = ic2.index_id AND i2.object_id = ic2.object_id 
		WHERE i2.name = N'IX_AIDBA_3_20230506' AND i2.object_id = OBJECT_ID('[FusionDW].[dbo].[ETLWatermark]')
		AND i.object_id = i2.object_id
		AND i.type = i2.type
		AND ic.index_column_id = ic2.index_column_id 
		AND ic.column_id = ic2.column_id
		...
		IF @pre_iid IS NOT NULL
		BEGIN
			DROP INDEX IX_AIDBA_3_20230506 ON [FusionDW].[dbo].[ETLWatermark];
			IF @pre_is_disable = 1
			BEGIN
			...
			ELSE
			BEGIN
				PRINT N'INDEX IX_AIDBA_3_20230506 ON [FusionDW].[dbo].[ETLWatermark] WILL NOT BE CREATED.';
			END
		END
		ELSE
		BEGIN
			PRINT N'INDEX IX_AIDBA_3_20230506 ON [FusionDW].[dbo].[ETLWatermark] WILL BE CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_3_20230506 ON [FusionDW].[dbo].[ETLWatermark] CANNOT BE CREATED DUE TO RUNTIME ERROR.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		INNER JOIN sys.index_columns ic
		ON i.index_id = ic.index_id AND i.object_id = ic.object_id
		WHERE i.name <> N'IX_AIDBA_4_20230506' AND i.object_id = OBJECT_ID('[FusionDW].[dbo].[FactDowntime]') 
		AND EXISTS
		(SELECT *
		FROM sys.indexes i2
		INNER JOIN sys.index_columns ic2
		ON i2.index_id = ic2.index_id AND i2.object_id = ic2.object_id 
		WHERE i2.name = N'IX_AIDBA_4_20230506' AND i2.object_id = OBJECT_ID('[FusionDW].[dbo].[FactDowntime]')
		AND i.object_id = i2.object_id
		AND i.type = i2.type
		AND ic.index_column_id = ic2.index_column_id 
		AND ic.column_id = ic2.column_id
		...
		IF @pre_iid IS NOT NULL
		BEGIN
			DROP INDEX IX_AIDBA_4_20230506 ON [FusionDW].[dbo].[FactDowntime];
			IF @pre_is_disable = 1
			BEGIN
			...
			ELSE
			BEGIN
				PRINT N'INDEX IX_AIDBA_4_20230506 ON [FusionDW].[dbo].[FactDowntime] WILL NOT BE CREATED.';
			END
		END
		ELSE
		BEGIN
			PRINT N'INDEX IX_AIDBA_4_20230506 ON [FusionDW].[dbo].[FactDowntime] WILL BE CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_4_20230506 ON [FusionDW].[dbo].[FactDowntime] CANNOT BE CREATED DUE TO RUNTIME ERROR.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		INNER JOIN sys.index_columns ic
		ON i.index_id = ic.index_id AND i.object_id = ic.object_id
		WHERE i.name <> N'IX_AIDBA_5_20230506' AND i.object_id = OBJECT_ID('[FusionDW].[dbo].[FactProduction]') 
		AND EXISTS
		(SELECT *
		FROM sys.indexes i2
		INNER JOIN sys.index_columns ic2
		ON i2.index_id = ic2.index_id AND i2.object_id = ic2.object_id 
		WHERE i2.name = N'IX_AIDBA_5_20230506' AND i2.object_id = OBJECT_ID('[FusionDW].[dbo].[FactProduction]')
		AND i.object_id = i2.object_id
		AND i.type = i2.type
		AND ic.index_column_id = ic2.index_column_id 
		AND ic.column_id = ic2.column_id
		...
		IF @pre_iid IS NOT NULL
		BEGIN
			DROP INDEX IX_AIDBA_5_20230506 ON [FusionDW].[dbo].[FactProduction];
			IF @pre_is_disable = 1
			BEGIN
			...
			ELSE
			BEGIN
				PRINT N'INDEX IX_AIDBA_5_20230506 ON [FusionDW].[dbo].[FactProduction] WILL NOT BE CREATED.';
			END
		END
		ELSE
		BEGIN
			PRINT N'INDEX IX_AIDBA_5_20230506 ON [FusionDW].[dbo].[FactProduction] WILL BE CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_5_20230506 ON [FusionDW].[dbo].[FactProduction] CANNOT BE CREATED DUE TO RUNTIME ERROR.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		BEGIN
			DROP INDEX IX_AIDBA_2_20230506 ON [FusionOperational].[dbo].[Downtime];
			PRINT N'HYPOTHETICAL INDEX IX_AIDBA_2_20230506 ON [FusionOperational].[dbo].[Downtime] IS DROPPED DUE TO DUPLICATION.';
			IF @is_disable = 1
			BEGIN
		...
		BEGIN
			...
			PRINT N'INDEX IX_AIDBA_2_20230506 ON [FusionOperational].[dbo].[Downtime] IS CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_2_20230506 ON [FusionOperational].[dbo].[Downtime] CANNOT BE CREATED.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		BEGIN
			DROP INDEX IX_AIDBA_3_20230506 ON [FusionDW].[dbo].[ETLWatermark];
			PRINT N'HYPOTHETICAL INDEX IX_AIDBA_3_20230506 ON [FusionDW].[dbo].[ETLWatermark] IS DROPPED DUE TO DUPLICATION.';
			IF @is_disable = 1
			BEGIN
		...
		BEGIN
			...
			PRINT N'INDEX IX_AIDBA_3_20230506 ON [FusionDW].[dbo].[ETLWatermark] IS CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_3_20230506 ON [FusionDW].[dbo].[ETLWatermark] CANNOT BE CREATED.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		BEGIN
			DROP INDEX IX_AIDBA_4_20230506 ON [FusionDW].[dbo].[FactDowntime];
			PRINT N'HYPOTHETICAL INDEX IX_AIDBA_4_20230506 ON [FusionDW].[dbo].[FactDowntime] IS DROPPED DUE TO DUPLICATION.';
			IF @is_disable = 1
			BEGIN
		...
		BEGIN
			...
			PRINT N'INDEX IX_AIDBA_4_20230506 ON [FusionDW].[dbo].[FactDowntime] IS CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_4_20230506 ON [FusionDW].[dbo].[FactDowntime] CANNOT BE CREATED.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		BEGIN
			DROP INDEX IX_AIDBA_5_20230506 ON [FusionDW].[dbo].[FactProduction];
			PRINT N'HYPOTHETICAL INDEX IX_AIDBA_5_20230506 ON [FusionDW].[dbo].[FactProduction] IS DROPPED DUE TO DUPLICATION.';
			IF @is_disable = 1
			BEGIN
		...
		BEGIN
			...
			PRINT N'INDEX IX_AIDBA_5_20230506 ON [FusionDW].[dbo].[FactProduction] IS CREATED.';
		END
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_5_20230506 ON [FusionDW].[dbo].[FactProduction] CANNOT BE CREATED.';
END CATCH;
