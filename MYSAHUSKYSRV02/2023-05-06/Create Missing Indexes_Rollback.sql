...
BEGIN TRAN
	...
	BEGIN
		...
		PRINT N'INDEX IX_AIDBA_2_20230506 ON [FusionOperational].[dbo].[Downtime] IS DROPPED.';
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_2_20230506 ON [FusionOperational].[dbo].[Downtime] CANNOT BE DROPPED.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		PRINT N'INDEX IX_AIDBA_3_20230506 ON [FusionDW].[dbo].[ETLWatermark] IS DROPPED.';
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_3_20230506 ON [FusionDW].[dbo].[ETLWatermark] CANNOT BE DROPPED.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		PRINT N'INDEX IX_AIDBA_4_20230506 ON [FusionDW].[dbo].[FactDowntime] IS DROPPED.';
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_4_20230506 ON [FusionDW].[dbo].[FactDowntime] CANNOT BE DROPPED.';
END CATCH;
...
BEGIN TRAN
	...
	BEGIN
		...
		PRINT N'INDEX IX_AIDBA_5_20230506 ON [FusionDW].[dbo].[FactProduction] IS DROPPED.';
	END
	ELSE
	BEGIN
...
IF @@TRANCOUNT > 0
ROLLBACK TRAN
	PRINT N'INDEX IX_AIDBA_5_20230506 ON [FusionDW].[dbo].[FactProduction] CANNOT BE DROPPED.';
END CATCH;
