BEGIN TRY ALTER INDEX [IX_AIDBA_28_20220401] ON [MFMB].[dbo].[EskerIDB] REORGANIZE;PRINT 'Index IX_AIDBA_28_20220401 on MFMB.dbo.EskerIDB has been reorganized'
				...
				END CATCH;
				BEGIN TRY
				ALTER INDEX [Hitachi_129399_129398_xProteinInterfaceData] ON [MTECH_V7_Intermediate_PROD].[mtech].[xProteinInterfaceData] REBUILD WITH (SORT_IN_TEMPDB = ON, FILLFACTOR = 70 );
				PRINT 'Index Hitachi_129399_129398_xProteinInterfaceData on MTECH_V7_Intermediate_PROD.mtech.xProteinInterfaceData has been rebuilt.'
				END TRY
				BEGIN CATCH
				PRINT 'Index Hitachi_129399_129398_xProteinInterfaceData does not exist on MTECH_V7_Intermediate_PROD.mtech.xProteinInterfaceData, or operation encountered an error.'
				END CATCH;
				BEGIN TRY
				ALTER INDEX [Hitachi_129405_129404_xProteinInterfaceData] ON [MTECH_V7_Intermediate_PROD].[mtech].[xProteinInterfaceData] REBUILD WITH (SORT_IN_TEMPDB = ON, FILLFACTOR = 70 );
				PRINT 'Index Hitachi_129405_129404_xProteinInterfaceData on MTECH_V7_Intermediate_PROD.mtech.xProteinInterfaceData has been rebuilt.'
				END TRY
				BEGIN CATCH
				PRINT 'Index Hitachi_129405_129404_xProteinInterfaceData does not exist on MTECH_V7_Intermediate_PROD.mtech.xProteinInterfaceData, or operation encountered an error.'
				END CATCH;
				BEGIN TRY
				ALTER INDEX [Hitachi_367489_367488_xProteinInterfaceData] ON [MTECH_V7_Intermediate_PROD].[mtech].[xProteinInterfaceData] REBUILD WITH (SORT_IN_TEMPDB = ON, FILLFACTOR = 70 );
				PRINT 'Index Hitachi_367489_367488_xProteinInterfaceData on MTECH_V7_Intermediate_PROD.mtech.xProteinInterfaceData has been rebuilt.'
				END TRY
				BEGIN CATCH
				PRINT 'Index Hitachi_367489_367488_xProteinInterfaceData does not exist on MTECH_V7_Intermediate_PROD.mtech.xProteinInterfaceData, or operation encountered an error.'
				END CATCH;
				BEGIN TRY
				ALTER INDEX [IX_AIDBA_39_20220401] ON [MTECH_V7_Intermediate_PROD].[mtech].[xProteinInterfaceData] REBUILD WITH (SORT_IN_TEMPDB = ON, FILLFACTOR = 70 );
				PRINT 'Index IX_AIDBA_39_20220401 on MTECH_V7_Intermediate_PROD.mtech.xProteinInterfaceData has been rebuilt.'
				END TRY
				BEGIN CATCH
				...
				END CATCH;
				BEGIN TRY
				ALTER INDEX [IX_HimEggRoomInventory_RecordType_TransactionIRN] ON [MTECH_v7_PRODUCTION].[mtech].[HimEggRoomInventory] REBUILD WITH (SORT_IN_TEMPDB = ON, FILLFACTOR = 100);
				PRINT 'Index IX_HimEggRoomInventory_RecordType_TransactionIRN on MTECH_v7_PRODUCTION.mtech.HimEggRoomInventory has been rebuilt.'
				END TRY
				BEGIN CATCH
