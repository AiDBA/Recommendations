...
BEGIN TRY
	IF EXISTS(  SELECT 1 FROM SYS.INDEXES I WHERE I.[IS_PRIMARY_KEY] = 1 AND I.[NAME] = 'Hitachi_368211_368210_xProteinInterfaceData')
	BEGIN
	ALTER INDEX [Hitachi_368211_368210_xProteinInterfaceData]
	ON [MTECH_V7_Intermediate_PROD].[mtech].[xProteinInterfaceData] DISABLE;
	PRINT 'INDEX [Hitachi_368211_368210_xProteinInterfaceData] ON [MTECH_V7_Intermediate_PROD].[mtech].[xProteinInterfaceData] IS DISABLED.';
	END
END TRY
BEGIN CATCH
	PRINT 'INDEX [Hitachi_368211_368210_xProteinInterfaceData] ON [MTECH_V7_Intermediate_PROD].[mtech].[xProteinInterfaceData] CANNOT BE DISABLED.';
END CATCH;
