...
BEGIN TRY
	...
	ON [MTECH_v7_PRODUCTION].[mtech].[HimEggTransfersDetails] REBUILD WITH (SORT_IN_TEMPDB = ON);
	PRINT 'INDEX [IX_HimEggTransfersDetails_HimEggPackagingTransIRN] ON [MTECH_v7_PRODUCTION].[mtech].[HimEggTransfersDetails] IS ENABLED.';
END TRY
BEGIN CATCH
	PRINT 'INDEX [IX_HimEggTransfersDetails_HimEggPackagingTransIRN] ON [MTECH_v7_PRODUCTION].[mtech].[HimEggTransfersDetails] CANNOT BE ENABLED.';
END CATCH;
