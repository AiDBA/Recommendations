...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [LineView4Reports].sys.stats S CROSS APPLY [LineView4Reports].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_dta_index_Faults_10_1234103437__K2_K9' AND OBJECT_NAME(S.OBJECT_ID) = 'Faults' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [LineView4Reports].[dbo].[Faults] [_dta_index_Faults_10_1234103437__K2_K9] WITH FULLSCAN ;
		END
		PRINT '[_dta_index_Faults_10_1234103437__K2_K9] on [LineView4Reports].[dbo].[Faults] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_dta_index_Faults_10_1234103437__K2_K9] on [LineView4Reports].[dbo].[Faults] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [LineView4Reports].sys.stats S CROSS APPLY [LineView4Reports].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_dta_stat_1234103437_9_2' AND OBJECT_NAME(S.OBJECT_ID) = 'Faults' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [LineView4Reports].[dbo].[Faults] [_dta_stat_1234103437_9_2] WITH FULLSCAN ;
		END
		PRINT '[_dta_stat_1234103437_9_2] on [LineView4Reports].[dbo].[Faults] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_dta_stat_1234103437_9_2] on [LineView4Reports].[dbo].[Faults] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [LineView4Reports].sys.stats S CROSS APPLY [LineView4Reports].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'Index_Faults_FaultCode_DTStamp' AND OBJECT_NAME(S.OBJECT_ID) = 'Faults' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [LineView4Reports].[dbo].[Faults] [Index_Faults_FaultCode_DTStamp] WITH FULLSCAN ;
		END
		PRINT '[Index_Faults_FaultCode_DTStamp] on [LineView4Reports].[dbo].[Faults] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[Index_Faults_FaultCode_DTStamp] on [LineView4Reports].[dbo].[Faults] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [LineView4Reports].sys.stats S CROSS APPLY [LineView4Reports].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000002_34C8D9D1' AND OBJECT_NAME(S.OBJECT_ID) = 'MachineCondCounts' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [LineView4Reports].[dbo].[MachineCondCounts] [_WA_Sys_00000002_34C8D9D1] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000002_34C8D9D1] on [LineView4Reports].[dbo].[MachineCondCounts] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000002_34C8D9D1] on [LineView4Reports].[dbo].[MachineCondCounts] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [LineView4Reports].sys.stats S CROSS APPLY [LineView4Reports].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000005_34C8D9D1' AND OBJECT_NAME(S.OBJECT_ID) = 'MachineCondCounts' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [LineView4Reports].[dbo].[MachineCondCounts] [_WA_Sys_00000005_34C8D9D1] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000005_34C8D9D1] on [LineView4Reports].[dbo].[MachineCondCounts] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000005_34C8D9D1] on [LineView4Reports].[dbo].[MachineCondCounts] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [LineView4Reports].sys.stats S CROSS APPLY [LineView4Reports].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'Index_MachineCondCounts_MachineId_Modified_DTStamp' AND OBJECT_NAME(S.OBJECT_ID) = 'MachineCondCounts' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [LineView4Reports].[dbo].[MachineCondCounts] [Index_MachineCondCounts_MachineId_Modified_DTStamp] WITH FULLSCAN ;
		END
		PRINT '[Index_MachineCondCounts_MachineId_Modified_DTStamp] on [LineView4Reports].[dbo].[MachineCondCounts] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[Index_MachineCondCounts_MachineId_Modified_DTStamp] on [LineView4Reports].[dbo].[MachineCondCounts] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [LineView4Reports].sys.stats S CROSS APPLY [LineView4Reports].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_MachineCondCounts' AND OBJECT_NAME(S.OBJECT_ID) = 'MachineCondCounts' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [LineView4Reports].[dbo].[MachineCondCounts] [PK_MachineCondCounts] WITH FULLSCAN ;
		END
		PRINT '[PK_MachineCondCounts] on [LineView4Reports].[dbo].[MachineCondCounts] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_MachineCondCounts] on [LineView4Reports].[dbo].[MachineCondCounts] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [LineView4Reports].sys.stats S CROSS APPLY [LineView4Reports].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000015_31EC6D26' AND OBJECT_NAME(S.OBJECT_ID) = 'Loss_Stops' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [LineView4Reports].[dbo].[Loss_Stops] [_WA_Sys_00000015_31EC6D26] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000015_31EC6D26] on [LineView4Reports].[dbo].[Loss_Stops] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000015_31EC6D26] on [LineView4Reports].[dbo].[Loss_Stops] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [LineView4Reports].sys.stats S CROSS APPLY [LineView4Reports].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'Index_Loss_Stops_Line_Code_Modified_DTStamp' AND OBJECT_NAME(S.OBJECT_ID) = 'Loss_Stops' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [LineView4Reports].[dbo].[Loss_Stops] [Index_Loss_Stops_Line_Code_Modified_DTStamp] WITH FULLSCAN ;
		END
		PRINT '[Index_Loss_Stops_Line_Code_Modified_DTStamp] on [LineView4Reports].[dbo].[Loss_Stops] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[Index_Loss_Stops_Line_Code_Modified_DTStamp] on [LineView4Reports].[dbo].[Loss_Stops] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [LineView4Reports].sys.stats S CROSS APPLY [LineView4Reports].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'dtLossStopsIndex' AND OBJECT_NAME(S.OBJECT_ID) = 'Loss_Stops' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [LineView4Reports].[dbo].[Loss_Stops] [dtLossStopsIndex] WITH FULLSCAN ;
		END
		PRINT '[dtLossStopsIndex] on [LineView4Reports].[dbo].[Loss_Stops] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[dtLossStopsIndex] on [LineView4Reports].[dbo].[Loss_Stops] cannot be updated.';			
	END CATCH;
END
