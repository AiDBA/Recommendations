...
BEGIN TRY
	IF EXISTS(  SELECT 1 FROM SYS.INDEXES I WHERE I.[IS_PRIMARY_KEY] = 1 AND I.[NAME] = 'IDX_N00789')
	BEGIN
	ALTER INDEX [IDX_N00789]
	ON [MIMS].[dbo].[PRODUCAO_REGISTRO] DISABLE;
	PRINT 'INDEX [IDX_N00789] ON [MIMS].[dbo].[PRODUCAO_REGISTRO] IS DISABLED.';
	END
END TRY
BEGIN CATCH
	PRINT 'INDEX [IDX_N00789] ON [MIMS].[dbo].[PRODUCAO_REGISTRO] CANNOT BE DISABLED.';
END CATCH;
