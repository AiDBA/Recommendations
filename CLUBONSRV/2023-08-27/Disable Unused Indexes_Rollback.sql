...
BEGIN TRY
	ALTER INDEX [IX_mrmSalesMaster]
	ON [ClubOnTest19].[dbo].[mrmSalesMaster] REBUILD WITH (SORT_IN_TEMPDB = ON);
	PRINT 'INDEX [IX_mrmSalesMaster] ON [ClubOnTest19].[dbo].[mrmSalesMaster] IS ENABLED.';
END TRY
BEGIN CATCH
	PRINT 'INDEX [IX_mrmSalesMaster] ON [ClubOnTest19].[dbo].[mrmSalesMaster] CANNOT BE ENABLED.';
END CATCH;
