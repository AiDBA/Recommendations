...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [CMS].sys.stats S CROSS APPLY [CMS].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000008_3AA1AEB8' AND OBJECT_NAME(S.OBJECT_ID) = 'invGoodsSoldHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [CMS].[dbo].[invGoodsSoldHeader] [_WA_Sys_00000008_3AA1AEB8] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000008_3AA1AEB8] on [CMS].[dbo].[invGoodsSoldHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000008_3AA1AEB8] on [CMS].[dbo].[invGoodsSoldHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [ClubOnTest].sys.stats S CROSS APPLY [ClubOnTest].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000012_7C7108C3' AND OBJECT_NAME(S.OBJECT_ID) = 'posOrderItem' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [ClubOnTest].[dbo].[posOrderItem] [_WA_Sys_00000012_7C7108C3] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000012_7C7108C3] on [ClubOnTest].[dbo].[posOrderItem] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000012_7C7108C3] on [ClubOnTest].[dbo].[posOrderItem] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [ClubOnTest19].sys.stats S CROSS APPLY [ClubOnTest19].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_PaymentType_79A9AAB1' AND OBJECT_NAME(S.OBJECT_ID) = 'posOrderPayment' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [ClubOnTest19].[dbo].[posOrderPayment] [_WA_Sys_PaymentType_79A9AAB1] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_PaymentType_79A9AAB1] on [ClubOnTest19].[dbo].[posOrderPayment] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_PaymentType_79A9AAB1] on [ClubOnTest19].[dbo].[posOrderPayment] cannot be updated.';			
	END CATCH;
END
