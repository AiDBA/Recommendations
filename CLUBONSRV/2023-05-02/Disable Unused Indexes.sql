...
BEGIN TRY
	...
	BEGIN
	ALTER INDEX [IX_mrmSalesMaster]
	ON [ClubOn_Train].[dbo].[mrmSalesMaster] DISABLE;
	PRINT 'INDEX [IX_mrmSalesMaster] ON [ClubOn_Train].[dbo].[mrmSalesMaster] IS DISABLED.';
	END
END TRY
BEGIN CATCH
	PRINT 'INDEX [IX_mrmSalesMaster] ON [ClubOn_Train].[dbo].[mrmSalesMaster] CANNOT BE DISABLED.';
END CATCH;
