...
BEGIN TRY
	...
	PRINT 'INDEX [FARD_IX_30397] ON [innova].[dbo].[proc_packs] IS ENABLED.';
END TRY
BEGIN CATCH
	PRINT 'INDEX [FARD_IX_30397] ON [innova].[dbo].[proc_packs] CANNOT BE ENABLED.';
END CATCH;
...
BEGIN TRY
	...
	ON [innova].[dbo].[proc_items] REBUILD WITH (SORT_IN_TEMPDB = ON);
	PRINT 'INDEX [ix_proc_items_porderline_rtype] ON [innova].[dbo].[proc_items] IS ENABLED.';
END TRY
BEGIN CATCH
	PRINT 'INDEX [ix_proc_items_porderline_rtype] ON [innova].[dbo].[proc_items] CANNOT BE ENABLED.';
END CATCH;
